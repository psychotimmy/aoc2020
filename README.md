...
**Day 14** Part 1 requires swapping between character and INTEGER\*8 representations of 36 bit numbers. Not difficult, except when you forget to write 2\*\*INT8(36-L1) rather than 2\*\*(36-1) as Fortran will provide an INTEGER\*4 result for the second version rather than INTEGER\*8. Even with lots of exponentiation flying around part 1 completes in 0.017s on a Pi4B. Part 2 to do.
